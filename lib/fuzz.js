...
module.exports = function(generators) {
    ...
    var ret = fuzz.bind(null, generators);

    ret.generate = generate.bind(null, generators);
...
function runTests(generator, r, fn, inv, amount) {
    math.range(amount).forEach(runTest.bind(null, generator, r, fn, inv));
}

function runTest(generator, r, fn, inv, i) {
